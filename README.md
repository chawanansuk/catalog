...
- 🏷️ **หมวดหมู่ 14 หมวด** จัดอัตโนมัติจากชื่อสินค้า — กด chip เลือกดู/ค้นในหมวดได้
- 📊 จัดอันดับผล: ตรงเป๊ะ → ขึ้นต้นด้วย → มีคำนี้ → ชื่อตรง
- 💰 แสดงราคาครบ: ราคาตอนนี้ (เด่น + ราคาเดิมขีดฆ่า), ขายส่ง, ราคาปลีก และราคาทุน (โหมดผู้บริหาร พร้อม % กำไร)
- 🧾 **ใบเสนอราคา** — เลือกหลายรายการ ปรับจำนวน/ราคา รวมยอด คัดลอก/ส่งทาง LINE
- 🖼️ รูปสินค้า + จุดเด่น/วัสดุ จากแคตตาล็อก (AI vision)
- ⚡ ค้นหาแบบ real-time จากฐานข้อมูล 5,066 รายการ — ติดตั้งเป็นแอป (PWA) ใช้ออฟไลน์ได้
...
สคริปต์จับคู่รหัสแบบยืดหยุ่น (ไม่สนตัวพิมพ์/ขีด/เว้นวรรค และลองเติม-ตัด `W` นำหน้าให้)
แถวที่จับคู่ไม่ได้จะถูกเขียนลง `unmatched-current-prices.txt` พร้อม**รหัสใกล้เคียงที่ระบบเดาให้**
— เปิดดู แก้รหัสในไฟล์ .docx ให้ถูก แล้วรันซ้ำ
